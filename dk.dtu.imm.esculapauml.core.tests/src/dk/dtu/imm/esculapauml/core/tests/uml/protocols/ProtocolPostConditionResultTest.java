...
/**
 * Tests successful scenario when the protocol order is valid and there is OCL
 * check of result of operation in PSM.
 * 
 * @author Piotr. J. Puczynski (piotr.puczynski)
 * 
 */
public class ProtocolPostConditionResultTest extends LoggingTest {

	private Resource model = TestUtils.getUMLResource("ProtocolPostConditionResult.uml");
	private Resource referenceModel = TestUtils.getUMLResource("results/ProtocolPostConditionResult.uml");
