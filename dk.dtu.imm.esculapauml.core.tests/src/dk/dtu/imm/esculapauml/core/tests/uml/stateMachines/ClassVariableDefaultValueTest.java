...
/**
 * Test class property default value visible in state machine.
 * 
 * @author Piotr J. Puczynski
 * 
 */
public class ClassVariableDefaultValueTest extends LoggingTest {
	private Resource model = TestUtils.getUMLResource("ClassVariableDefaultValue.uml");
