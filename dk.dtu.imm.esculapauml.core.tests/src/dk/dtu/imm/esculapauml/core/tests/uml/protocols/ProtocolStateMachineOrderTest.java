...
/**
 * Tests successful scenario when the protocol order is valid.
 * 
 * @author Piotr. J. Puczynski (piotr.puczynski)
 * 
 */
public class ProtocolStateMachineOrderTest extends LoggingTest {

	private Resource model = TestUtils.getUMLResource("ProtocolStateMachineOrder.uml");
	private Resource referenceModel = TestUtils.getUMLResource("results/ProtocolStateMachineOrder.uml");
